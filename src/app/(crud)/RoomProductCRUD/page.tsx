...
//             title={[<h6 className="font-semibold m-0">Danh sách sản phẩm</h6>]}
//             extra={[
//               <Button type="primary">
...
//                 Thông tin bàn đã có sản phẩm mặt định
//               </h6>,
//             ]}
...
//                       <Descriptions title="Bàn ???">
//                         <Descriptions.Item label="Sản phẩm mặc định" span={3}>
//                          Hình ảnh các sản phẩm mặc định
//                         </Descriptions.Item>
//                         {/* <Descriptions.Item label="Sản phẩm mặt định" span={3}>
//                           Viking Burrito
//                         </Descriptions.Item>
...
//   );
// };
// export default AppRoomProductCTRL;
